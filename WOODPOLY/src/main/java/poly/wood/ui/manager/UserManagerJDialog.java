...
import poly.wood.controller.UserController;
...
public class UserManagerJDialog extends javax.swing.JDialog implements UserController {
    ...
    private void initComponents() {
        ...
        lblImage.setIcon(new javax.swing.ImageIcon("D:\\Java 3\\WOODPOLY\\src\\main\\resources\\poly\\cafe\\icons\\nguoi.png")); // NOI18N
    ...
    if (username.isEmpty()) {
        ...
        JOptionPane.showMessageDialog(this, "Không được để trống xác nhận mật khẩu", "Lỗi", JOptionPane.ERROR_MESSAGE);
    } else if (fullname.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Không được để trống họ và tên", "Lỗi", JOptionPane.ERROR_MESSAGE);
...
if (username.isEmpty()) {
    ...
    JOptionPane.showMessageDialog(this, "Tên đăng nhập phải chứa ký tự '@'", "Lỗi", JOptionPane.ERROR_MESSAGE);
} else {
    // Kiểm tra trùng tên đăng nhập
    List<User> existingUsers = dao.findAll();
