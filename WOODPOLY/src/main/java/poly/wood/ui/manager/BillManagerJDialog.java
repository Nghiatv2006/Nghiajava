...
import poly.wood.controller.BillController;
...
public class BillManagerJDialog extends javax.swing.JDialog implements BillController {
    ...
    private void initComponents() {
        ...
        btnSearchUser.setText("Lọc User");
        ...
        tblBillDetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Đồ gỗ", "Đơn giá", "Giảm giá", "Số lượng", "Thành tiền"
            }
        ));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(28, 28, 28)
                .addComponent(tabs, javax.swing.GroupLayout.PREFERRED_SIZE, 896, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        // Kiểm tra rỗng
        if (idText.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Không được để trống mã phiếu", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            if (id < 0) {
                JOptionPane.showMessageDialog(this, "Mã phiếu phải là số nguyên dương", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Mã phiếu phải là số nguyên", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
        this.update();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        String idText = txtId.getText().trim();
        String creator = txtUsername.getText().trim(); // Người tạo
        String createdTime = txtCheckin.getText().trim(); // Thời điểm tạo
        String paidTime = txtCheckout.getText().trim(); // Thời điểm thanh toán
...
// === Kiểm tra Mã phiếu có phải số nguyên dương ===
        Long id = null;
        try {
            id = Long.parseLong(idText);
            if (id < 0) {
...
// === Kiểm tra trùng mã phiếu ===
        for (Bill b : dao.findAll()) {
            if (b.getId().equals(id)) {
                JOptionPane.showMessageDialog(this, "Mã phiếu đã tồn tại", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }

// === Kiểm tra radio button trạng thái (ít nhất 1 được chọn) ===
...
// === Kiểm tra người tạo rỗng ===
        if (creator.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Không được để trống người tạo", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }

// === Kiểm tra thời điểm tạo (nếu bắt buộc nhập) ===
        if (createdTime.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập thời điểm tạo", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }

// === (Tùy chọn) Kiểm tra thời điểm thanh toán nếu trạng thái là Completed ===
        if (rdoCompleted.isSelected() && paidTime.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Hãy nhập thời điểm thanh toán khi phiếu đã hoàn thành", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
...
// Nếu mọi thứ hợp lệ
    ...
    private void btnSearchUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchUserActionPerformed
        // TODO add your handling code here:
        String username = (String) cboUsername.getSelectedItem(); // từ comboBox
        Date begin = XDate.parse(txtBegin.getText(), "MM/dd/yyyy");
        Date end = XDate.parse(txtEnd.getText(), "MM/dd/yyyy");

        items = dao.findByUserAndTimeRange(username, begin, end);
    ...
    @Override
    public void edit() {
        Bill entity = items.get(tblBills.getSelectedRow()); // <-- phải lấy trước!

        String createdBy = entity.getUsername(); // <-- chính xác
        String loggedIn = XAuth.user.getUsername();
        boolean isManager = XAuth.user.isManager();

        if (!isManager && !createdBy.equalsIgnoreCase(loggedIn)) {
            JOptionPane.showMessageDialog(this, "Bạn không có quyền chỉnh sửa phiếu này!");
            return; // thoát luôn
        }
    ...
    public void setEditable(boolean editable) {
        ...
        // Kiểm tra quyền sửa
        String createdBy = txtUsername.getText().trim(); // người tạo phiếu
        String loggedIn = XAuth.user.getUsername(); // người đăng nhập
        boolean isManager = XAuth.user.isManager(); // quyền quản lý

        boolean canEdit = isManager || createdBy.equalsIgnoreCase(loggedIn);

        btnUpdate.setEnabled(editable && canEdit);
        btnDelete.setEnabled(editable && canEdit);
