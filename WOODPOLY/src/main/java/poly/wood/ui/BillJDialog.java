...
import poly.wood.controller.BillDetailsController;
 ...
 * @author ADMIN
 */
public class BillJDialog extends javax.swing.JDialog implements BillDetailsController {
    ...
    public BillJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null); // Set giữa màn hình luôn
    }
    ...
    private void initComponents() {
        ...
        tblBillDetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Mã phiếu", "Đồ gỗ", "Đơn giá", "Giảm giá", "Số lượng", "Thành tiền"
            }
        ) {
    ...
    public void showDrinkJDialog() {
         WoodJDialog dialog = new WoodJDialog((Frame) this.getOwner(), true);
